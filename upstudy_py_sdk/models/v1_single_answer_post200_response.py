...
class V1SingleAnswerPost200Response(BaseModel):
    """
    V1SingleAnswerPost200Response
    """ # noqa: E501
    data: Optional[SolverSelfSimpleResponse] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": SolverSelfSimpleResponse.from_dict(obj["data"]) if obj.get("data") is not None else None,
