...
class SolverSelfBriefResponse(BaseModel):
    """
    SolverSelfBriefResponse
    """ # noqa: E501
    input: Optional[StrictStr] = Field(default=None, description="User's Latex input")
    solutions: Optional[List[SolverSolution]] = Field(default=None, description="All solutions we can provide")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "input": obj.get("input"),
            "solutions": [SolverSolution.from_dict(_item) for _item in obj["solutions"]] if obj.get("solutions") is not None else None
        })
        return _obj
