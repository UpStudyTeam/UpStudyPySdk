...
class V1ShowStepsPost200Response(BaseModel):
    """
    V1ShowStepsPost200Response
    """ # noqa: E501
    data: Optional[SolverSelfFullResponseText] = None
    err_msg: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["data", "err_msg"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": SolverSelfFullResponseText.from_dict(obj["data"]) if obj.get("data") is not None else None,
