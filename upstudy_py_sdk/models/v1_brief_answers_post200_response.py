...
class V1BriefAnswersPost200Response(BaseModel):
    """
    V1BriefAnswersPost200Response
    """ # noqa: E501
    data: Optional[SolverSelfBriefResponse] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": SolverSelfBriefResponse.from_dict(obj["data"]) if obj.get("data") is not None else None,
